...
namespace Hyperbolaa\Alisms\Core\Profile;
use Hyperbolaa\Alisms\Core\Auth\ShaHmac1Signer;
use Hyperbolaa\Alisms\Core\Auth\Credential;
use Hyperbolaa\Alisms\Core\Regions\EndpointProvider;
use Hyperbolaa\Alisms\Core\Regions\ProductDomain;
use Hyperbolaa\Alisms\Core\Regions\Endpoint;
